...
- RESTful API Design, Microservices-Architekturen
- Datenbankmodellierung und -optimierung

**Datenbanken**
- MySQL, PostgreSQL, H2 Database
- JPA / Hibernate, Query-Optimierung
...
- Testabdeckung und automatisierte Tests
...
3. **Microservices-Demo** implementieren
